...
// takes in a targetSum and an array of numbers
// as arguments.
...
// as needed. You may assume that all input numbers
// are nonnegative.
    ...
    for(let i = 0; i <= targetSum; i++) {
        if(table[i] === true) {
            for(let num of numbers) {
                table[i + num] = true; // can be buggy in different languages but ok for JS
            }
        }
    }
